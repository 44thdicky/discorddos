...
interface=eth0
dumpdir=/root/dumps
url='https://your-webhook-url'  ## Use a secure method for handling this URL
...
while true; do
  ...
  if [ $pps -gt 10000 ]; then
    ...
    echo -ne "\r$mbps megabytes/s\033[97m"
    ...
    curl -H "Content-Type: application/json" -X POST -d '{
      "embeds": [{
        ...
        "footer": {
          ...
          "icon_url": "https://www.countryflags.com/wp-content/uploads/united-kingdom-flag-png-large.png"
        },
